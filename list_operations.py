...
#or the next four functions, get clever using slice operations described in the first half
def custom_append(input_list, value):
    ...
    # return input_list
    new_list = [value]
    input_list[custom_len(input_list):] = new_list
    return input_list


def custom_extend(input_list, values):
    """custom_extend(input_list, values) imitates input_list.extend(values)"""
    #calling custom_len function to get starting index for extension, : indicates end of list
    # values are added to input list with clarified start through end indices
    # list.extend(L) is equivalent to a[len(a):] = L
